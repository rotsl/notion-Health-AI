...
class AIInsightsEngine:
    ...
    async def generate_health_insights(
        ...
        for cat in categories:
            try:
                insight = await self._generate_category_insight(cat, metrics, summary)
                if insight:
    ...
    async def _generate_category_insight(
        ...
        prompt = self._build_analysis_prompt(category, metrics, summary)
...
""",
        ...
        return category_prompts.get(category, category_prompts["overall"])
