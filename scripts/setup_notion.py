...
class NotionSetup:
    ...
    def seed_sample_data(self, database_ids: Dict[str, str]):
        ...
        # ── Health Metrics (10 days of realistic data) ─────────────────
        hm_id = database_ids.get("health_metrics")
        if hm_id:
            rows = [
                ("2026-03-21", 174.4, 6.7, 6, 6, 6, 6800, 5, None, None),
                ("2026-03-22", 174.1, 7.2, 7, 7, 7, 7600, 6, "walking", 25),
                ("2026-03-23", 173.9, 7.0, 6, 6, 6, 7200, 6, None, None),
                ...
                ("2026-03-30", 172.4, 7.8, 8, 8, 8, 9400, 8, "strength_training", 35),
            ]
        ...
        if appt_id:
            appts = [
                ("Dr. Sarah Chen", "2026-04-15", "10:00", "checkup",
                 "City Medical Center", "Annual physical checkup", "scheduled"),
                ("Dr. James Martinez", "2026-05-02", "14:00", "dental",
                 "Bright Smile Dental", "Routine dental cleaning and X-rays", "scheduled"),
                ("Dr. Priya Sharma", "2026-04-28", "15:30", "mental_health",
        ...
        if sym_id:
            symptoms = [
                ("Headache", "2026-03-25", "14:00", 4, "head", 120,
                 "Possible trigger: dehydration. Resolved after drinking water and resting 30 min."),
                ("Lower Back Tension", "2026-03-27", "16:30", 3, "lower back", 60,
                 "After 4+ hours of sitting. Resolved with stretching and short walk."),
                ("Mild Fatigue", "2026-03-29", "18:15", 3, "whole body", 90,
                 "Followed a short night of sleep and improved after dinner and rest."),
            ]
